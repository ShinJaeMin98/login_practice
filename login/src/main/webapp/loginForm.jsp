...
<div class="login-box">
  <h2>Login</h2>
  <form action="loginProcess" name="form" method="post">
    <div class="user-box">
      <input type="text" name="user_id" required="required" value="test"/>
      <label>Username</label>
    </div>
    <div class="user-box">
      <input type="password" name="user_pw" required="required" value="1234"/>
